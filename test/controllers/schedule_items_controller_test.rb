...
class ScheduleItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule_item" do
    assert_difference('ScheduleItem.count') do
      post schedule_items_url, params: { schedule_item: { attended: @schedule_item.attended, scheduledDate: @schedule_item.scheduledDate, scheduledTime: @schedule_item.scheduledTime, subtitle: @schedule_item.subtitle, title: @schedule_item.title } }
    end
  ...
  test "should update schedule_item" do
    patch schedule_item_url(@schedule_item), params: { schedule_item: { attended: @schedule_item.attended, scheduledDate: @schedule_item.scheduledDate, scheduledTime: @schedule_item.scheduledTime, subtitle: @schedule_item.subtitle, title: @schedule_item.title } }
